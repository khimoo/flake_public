...
| [zettelkasten-obsidian-config.md](./zettelkasten-obsidian-config.md) | `.obsidian` 設定の配布（public repo から seed-once コピー）と、将来 config を public repo に source-of-truth 化してリンクする構想 |
