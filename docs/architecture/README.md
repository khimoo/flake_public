...
| [private-repo-clone.md](./private-repo-clone.md) | private repo の宣言的 clone（home-manager の home.activation で age 鍵 1 本から SSH 鍵を復号し clone・NixOS/WSL/macOS 共通・eval 時の鍵依存という限界） |
