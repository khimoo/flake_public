...
| [kitty.md](./kitty.md) | 端末を wezterm から kitty へ移す判断。tmux を挟む案を退けた理由、`Ctrl+a > 階層 > 動詞` のキー体系と 3 マスを空けたままにする理由、`socket-only` を選んだ理由、smart-splits の `at_edge = "wrap"` が kitty でも動く根拠 |
